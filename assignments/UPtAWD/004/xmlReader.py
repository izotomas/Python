'''
Welcome Tomas Izo from Using Python to Access Web Data
...
Actual data: http://python-data.dr-chuck.net/comments_267602.xml (Sum ends with 16)
...
url = 'http://python-data.dr-chuck.net/comments_267602.xml'
xml = ET.fromstring(urllib.urlopen(url).read())

#print urllib.urlopen(url).read()
print sum(int(i.text) for i in xml.findall('.//count'))